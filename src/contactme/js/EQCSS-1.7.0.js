...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    //root.EQCSS = factory();
    (typeof globalThis !== 'undefined' ? globalThis : window).EQCSS = factory();
  }
    ...
    // Replace `with` by explicitly referencing $it properties
    const scopedEval = (context, expression) => {
    ...
    EQCSS.tryWithEval = function(element, string) {
      ...
      try {
        ...
        ret = scopedEval({$it}, string.slice(1, -1));
